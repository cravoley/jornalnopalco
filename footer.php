...
<script src="<?php echo get_template_directory_uri();?>/js/native.history.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri() . '/lib/html5lightbox/html5lightbox.js'; ?>" async></script>
