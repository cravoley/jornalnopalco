	...
	(function ($) {
		$.fn.html5lightbox = function (options) {
			...
			var ELEM_TYPE = 0, ELEM_HREF = 1, ELEM_TITLE = 2, ELEM_GROUP = 3, ELEM_WIDTH = 4, ELEM_HEIGHT = 5, ELEM_HREF_WEBM = 6,
				ELEM_HREF_OGG = 7, ELEM_THUMBNAIL = 8, ELEM_DESCRIPTION = 9, HASH_APPEND = 1, HASH_CLEAN = 2, HASH_LOAD = 3, HASH_BASE = "?midia=";
...
//						console.log(gaparams);
			...
			inst.handleHash = function (what, hash) {
				...
				if (what == HASH_LOAD) {
					...
					if (h.indexOf(HASH_BASE) !== 0)return;
			...
			// console.log(inst);
			// return inst.unbind("click").on("click", inst.clickHandler);
